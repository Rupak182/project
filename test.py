...
def test_dataset(name, texts, true_labels, tokenizer, model, xgb_model, device):
    print(f"\n{'='*60}")
...
def main():
    ...
    results["Hand-typed"] = test_dataset("Hand-typed Examples", typed_texts, typed_labels, tokenizer, model, xgb_model, device)
